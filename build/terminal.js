...
(function (global) {
  ...
  define('terminal/options',["angular"], function (angular) {
...
(function () {
  define('terminal/src/template_renderer/terminal_template',[], function () {
    var template = "" +
...
//      cbtPlayer.style.opacity = 0;
  ...
  define(
      'terminal/src/template_renderer',[
          "angular",
...
(function (global) {
  ...
  define('terminal/src/controllers/term_ctrl',[
    "angular"
  ], function (angular) {
...
(function () {
  ...
  define('terminal/src/controllers',["angular", "./controllers/term_ctrl"], function (angular, TermCtrl) {
...
(function (global) {
    ...
    define('terminal/src/directives/scrubber-tooltip/link',["angular"],
        function (angular) {
...
(function () {
    define('terminal/src/directives/scrubber-tooltip/template',[], function () {
        return "" +
            "<div>" +
            "</div>";
    });
...
(function () {
    ...
    define('terminal/src/directives/scrubber-tooltip',[
...
(function (global) {
  ...
  define('terminal/src/directives',[
...
(function () {
  ...
  define('terminal/src/services',["angular"], function (angular) {
...
(function () {
  ...
  define('terminal/src/values',[], function () {
    return Values;
  });
}());
(function () {
...
(function () {
  ...
  define('terminal/boot',["./terminal_boot"], function (terminal) {
...
(function () {
  ...
  define('terminal',["./terminal/options", "./terminal/boot"], function (Options, Boot) {
