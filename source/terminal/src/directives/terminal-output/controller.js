(function () {
	var Controller = function ($scope, $terminalConfiguration, $promptCreator, $q) {
...
var mainText = ['\nPlease click the screen to start.',
	...
	define(["angular"], function (angular) {
		...
		Controller.$inject = ['$scope', '$terminalConfiguration', '$promptCreator', '$q'];
		return Controller;
	});
}());